...
export default function EducationFields() {
    ...
    const handlers = useSwipeable({
        onSwipedLeft: () => {/* Navigate to next field */},
        onSwipedRight: () => {/* Navigate to previous field */},
    });
    ...
    return (
        <div className="bg-gray-100 min-h-screen flex flex-col">
            <div className="container mx-auto py-27 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 max-w-5xl w-full">
