    ...
    return (
        <div className="relative w-full">
            <button
                ...
                className={`absolute top-2 right-20 z-10 py-1.5 rounded-full text-sm font-medium transition-all duration-200 flex items-center gap-2 ${isFollowed ? 'bg-blue-50 text-blue-600' : 'bg-white text-gray-600 hover:bg-gray-50 shadow-sm'}`}>
